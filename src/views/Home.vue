    ...
    <div class="flex flex-col items-center space-y-6">
      <div class="w-full max-w-md bg-white rounded-lg shadow-md p-6">
        ...
        <ul class="space-y-2">
          ...
          <li class="flex items-center">
            <span
              class="inline-block w-3 h-3 rounded-full bg-orange-500 mr-2"
            ></span>
            Pinia
          </li>
          <li class="flex items-center">
          ...
          <li class="flex items-center">
            <span
              class="inline-block w-3 h-3 rounded-full bg-indigo-500 mr-2"
            ></span>
            TDesign Mobile Vue
          </li>
          <li class="flex items-center">
            <span
              class="inline-block w-3 h-3 rounded-full bg-pink-500 mr-2"
            ></span>
            TailwindCSS + Less
          </li>
        </ul>
      </div>
      <Button theme="primary" @click="handleClick">点击测试</Button>
    </div>
  </div>
</template>
